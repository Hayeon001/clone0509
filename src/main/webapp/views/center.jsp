<%--select gender,SUM(price) from sales GROUP BY gender--%>
<%--select rdate, gender,SUM(price) from sales GROUP BY rdate, gender ORDER BY 1;--%>
<%--월별 : select TO_CHAR(rdate,'MM'), gender,SUM(price) from sales GROUP BY TO_CHAR(rdate,'MM'), gender ORDER BY 1;--%>
<%--TO_CHAR : string, TO_NUMBER : 숫자 TO_NUMBER(TO_CHAR(rdate,'MM'))--%>

<%--select TO_NUMBER(TO_CHAR(rdate,'MM')), gender,SUM(price) from sales GROUP BY TO_CHAR(rdate,'MM'), gender ORDER BY 1;--%>
<%--select TO_NUMBER(TO_CHAR(rdate,'MM')) AS month, gender,SUM(price) AS total from sales GROUP BY TO_CHAR(rdate,'MM'), gender ORDER BY 1;--%>
